...
В файле transqction_processor.py реализованы функции, считывающие данные о финансовых операциях из CSV- и XLSX-файлов. 
Также обеспечено их тестирование в соответствующем разделе проекта.
