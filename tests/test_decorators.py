...
from typing import Any, Callable, Optional, TypeVar, TextIO, Type
...
def test_log_to_file_success() -> None:
    ...
    if os.path.exists("test_log.txt"):
        os.remove("test_log.txt")  # Удаляем старый лог
...
def test_log_to_file_error() -> None:
    ...
    @log(filename=log_file)  # Логируем в файл
